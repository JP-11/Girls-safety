package com.android.src.receiver;
import com.android.src.handwaving.HandWavingAct;
import com.android.src.handwaving.IPAddressForm;
	 ...
	 public static boolean wasScreenOn = true;
		...
		public void onReceive(Context context, Intent intent) {
	        ...
	        if (intent.getAction().equals(Intent.ACTION_SCREEN_OFF)) {
	        	...
	        	wasScreenOn=false;
	        	Intent intent11 = new Intent(context,HandWavingAct.class);
	        	...
	        	wasScreenOn=true;
	        	Intent intent11 = new Intent(context,IPAddressForm.class);
	        	intent11.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
